...
;P0Top = temp5
P0Top = $D4 ; changed to hard value to avoid dasm issues
P0Bottom = $A4
P1Bottom = $A5
...
P1display = $D1 ; changed to hard value to avoid dasm issues
lifepointer = $c1
lives = $c2
pfscore1 = $c1
pfscore2 = $c2
...
;RepoLine = temp4
RepoLine = $D3 ; changed to hard value to avoid dasm issues
...
temp1 = $D0 ;used by kernel.  can be used in program too, but
temp2 = $D1 ;are obliterated when drawscreen is called.
temp3 = $D2
temp4 = $D3
temp5 = $D4
temp6 = $D5
temp7 = $D6 ; This is used to aid in bankswitching
